...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '210b67dbfc9a80ed8f3fd06983ba70b2,en:210b67dbfc9a8140b9a0000c10157bd6',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'thestar', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '国家一级保护废物', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.thestar0.site/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '红队,攻防,钓鱼,逆向工程,代码混淆技术,java安全,渗透测试,安全工具开发,漏洞复现,安全研究,工具分享,CTF,加密与解密', // 网站关键词 英文逗号隔开

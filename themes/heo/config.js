const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2021-11-28', // 建站日期，用于计算网站运行的第几天
  ...
  HEO_HERO_CATEGORY_2: { title: '安全研究', url: '/category/安全研究' },
  HEO_HERO_CATEGORY_3: { title: 'CTF', url: '/category/CTF' },
